...
from xnano.beta import events as xnano_events

if TYPE_CHECKING:
    from xnano.beta.events import KeyboardEventKind, MouseEventKind
    from xnano.beta.events import KeyboardModifier
