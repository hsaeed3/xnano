...
import xnano.core.runtime
from xnano.core import Frame, Runtime
from xnano.core.runtime import (
    _ACTIVE_RUNTIME,
    _EXIT_SIGNALS,
...
def test_cursor_move_updates_position_and_frame() -> None:
    """``runtime.cursor`` is the decoupled cursor tracker (xnano.cursor),
...
def test_grid_effect_uses_recorded_field_area() -> None:
    from xnano.effects import FadeEffect
    from xnano.fields import Field
    from xnano.grids import BaseGrid
