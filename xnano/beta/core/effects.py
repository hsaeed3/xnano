"""xnano.beta.core.effects

---

Turn beta effect descriptions into native ``tachyonfx`` effects.
"""
...
from xnano.beta.colors import Color, ColorLike
...
def resolve_native_effect(
    ...
    *,
    ...
    ``xnano.beta.effects`` module docstring for why this lowering step lives
