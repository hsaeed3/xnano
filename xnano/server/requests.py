...
Serve ``@on_*_request`` hooks with the standard library HTTP server.
"""
...
from xnano.requests import Request, Response, dispatch_request
...
class _RequestHandler(http.server.BaseHTTPRequestHandler):
    """Translate HTTP requests into request-hook dispatch."""
