...
class Constraint:
    ...
    @staticmethod
    def from_ratios(
        values: collections.abc.Sequence[Tuple[int, int]],
    ) -> list[Constraint]: ...
    @staticmethod
    def from_mins(
        values: collections.abc.Sequence[int],
...
class Layout:
    ...
    @staticmethod
    def new(
        direction: Direction, constraints: collections.abc.Sequence[Constraint]
    ) -> Layout: ...
    @staticmethod
    def vertical(
        constraints: collections.abc.Sequence[Constraint],
    ) -> Layout: ...
    @staticmethod
    def horizontal(
        constraints: collections.abc.Sequence[Constraint],
    ...
    def constraints(
        self, constraints: collections.abc.Sequence[Constraint]
    ) -> Layout: ...
...
class Line:
    ...
    @staticmethod
    def from_spans(spans: collections.abc.Sequence[Span]) -> Line: ...
    ...
    def spans(self, spans: collections.abc.Sequence[Span]) -> Line: ...
    def __repr__(self) -> str: ...
...
class Text:
    ...
    @staticmethod
    def from_lines(lines: collections.abc.Sequence[Line]) -> Text: ...
...
class TitlePosition(enum.IntEnum):
...
class HighlightSpacing(enum.IntEnum):
...
class ListDirection(enum.IntEnum):
...
class RatList:
    ...
    @staticmethod
    def new(items: collections.abc.Sequence[Any]) -> RatList: ...
    ...
    def items(self, items: collections.abc.Sequence[Any]) -> RatList: ...
...
class Row:
    ...
    @staticmethod
    def new(cells: collections.abc.Sequence[Any]) -> Row: ...
    ...
    def cells(self, cells: collections.abc.Sequence[Any]) -> Row: ...
...
class RatTable:
    ...
    @staticmethod
    def new(
        rows: collections.abc.Sequence[Row],
        widths: collections.abc.Sequence[Constraint],
    ) -> RatTable: ...
    ...
    def rows(self, rows: collections.abc.Sequence[Row]) -> RatTable: ...
    def widths(
        self, widths: collections.abc.Sequence[Constraint]
    ) -> RatTable: ...
...
class Tabs:
    ...
    @staticmethod
    def new(titles: collections.abc.Sequence[Any]) -> Tabs: ...
    def block(self, block: Block) -> Tabs: ...
    def style(self, style: Style) -> Tabs: ...
    def highlight_style(self, style: Style) -> Tabs: ...
    def titles(self, titles: collections.abc.Sequence[Any]) -> Tabs: ...
...
class Sparkline:
    ...
    @staticmethod
    def new(data: collections.abc.Sequence[int]) -> Sparkline: ...
    @staticmethod
    def from_bars(
        bars: collections.abc.Sequence[SparklineBar],
    ) -> Sparkline: ...
    def data(self, data: collections.abc.Sequence[int]) -> Sparkline: ...
    def bars(
        self, bars: collections.abc.Sequence[SparklineBar]
    ) -> Sparkline: ...
...
class BarGroup:
    ...
    @staticmethod
    def new(bars: collections.abc.Sequence[Bar]) -> BarGroup: ...
...
class BarChart:
    ...
    @staticmethod
    def new(groups: collections.abc.Sequence[BarGroup]) -> BarChart: ...
...
class Dataset:
    ...
    def data(
        self, values: collections.abc.Sequence[tuple[float, float]]
    ) -> Dataset: ...
...
class Axis:
    ...
    def labels(self, values: collections.abc.Sequence[Any]) -> Axis: ...
    def style(self, value: Style) -> Axis: ...
    def labels_alignment(self, alignment: Alignment) -> Axis: ...

class Chart:
    @staticmethod
    def new(datasets: collections.abc.Sequence[Dataset]) -> Chart: ...
...
class Buffer:
    ...
    @staticmethod
    def with_lines(lines: collections.abc.Sequence[str | Line]) -> Buffer: ...
    @property
    def area(self) -> Rect: ...
...
class KeyEventKind(enum.IntEnum):
    """Key event phase.
...
class MouseEventKind(enum.IntEnum):
    """Mouse event kind.
...
class Terminal:
    ...
    def init() -> Terminal: ...
    def draw(
        self, callback: collections.abc.Callable[[Frame], Any]
    ) -> None: ...
    def try_draw(
        self, callback: collections.abc.Callable[[Frame], Any]
    ) -> CompletedFrame: ...
...
class ConsoleColor(enum.IntEnum):
...
class ConsoleAttribute(enum.IntEnum):
...
class EvolveSymbolSet(enum.IntEnum):
...
class CellFilter:
    ...
    @staticmethod
    def all_of(
        filters: collections.abc.Sequence[CellFilter],
    ) -> CellFilter: ...
    @staticmethod
    def any_of(
        filters: collections.abc.Sequence[CellFilter],
    ...
    @staticmethod
    def position_fn(
        callback: collections.abc.Callable[[int, int], bool],
    ) -> CellFilter: ...
    @staticmethod
    def eval_cell(
        callback: collections.abc.Callable[[str, Color, Color], bool],
    ) -> CellFilter: ...
...
def sequence_effects(effects: collections.abc.Sequence[Effect]) -> Effect:
    """Run effects in sequence. See :func:`tachyonfx::fx::sequence`."""

def parallel_effects(effects: collections.abc.Sequence[Effect]) -> Effect:
