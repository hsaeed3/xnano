...
if TYPE_CHECKING:
    ...
    from xnano.grid import Grid, _GridSlideCapture
    from xnano.hooks import PollWhen
    from xnano.terminal import Terminal
    from xnano.types import Area, Coordinate
...
def measure_renderable_in_field(
    ...
    Returns:
        ...
        overhead.
    """
    from xnano.utils.native_types import frame_length_overhead
...
def _handle_focus_navigation(terminal: "Terminal[Any]", keyboard: Any) -> bool:
    ...
    """
    from xnano.focus import cycle_field_focus
...
def _handle_focused_text_input(
    ...
    from xnano.focus import apply_text_keyboard, focused_input_text
...
def dispatch_hooks(terminal: "Terminal[Any]", ctx: "Context[Any]") -> None:
    ...
    if event.is_keyboard_event():
        ...
        from xnano.focus import focused_input_text
...
def dispatch_field_mouse(
    ...
    for hit in reversed(terminal._field_hits):
        ...
        if mouse.kind == "press":
            from xnano.focus import is_input_text, set_field_focus
...
def drain_pending_hooks(terminal: "Terminal[Any]") -> None:
    from xnano.hooks import _PENDING_HOOKS
