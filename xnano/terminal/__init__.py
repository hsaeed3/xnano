...
if TYPE_CHECKING:
    ...
    from xnano.frame import FrameTitlePosition
...
from xnano.core import dispatch as _dispatch
...
class Terminal(Generic[StateT]):
    ...
    def blur_field(self) -> None:
        ...
        from xnano.focus import clear_field_focus
    ...
    def session(self) -> "TerminalController[StateT]":
        ...
        if self._session is None:
            from xnano.exceptions import TerminalNotActiveError
